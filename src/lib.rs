...
pub mod vcf;      // VCF file processing and variant extraction
pub mod variant;  // Variant analysis and sequence comparison
pub mod output;   // Output formatting and compression
pub mod types;    // Common data structures and types

// Re-export commonly used types for convenience
pub use types::{BedRegion, Variant};
pub use bam::query_bam_records_for_region;
pub use bed::load_bed_regions;
pub use vcf::{query_vcf_variants_for_region, parse_bnd_variant};
pub use variant::{read_spans_variant_position, analyze_read_variant_content, extract_read_bases_at_position, analyze_read_allele_content_detailed, classify_variant_type, AlleleMatch};
